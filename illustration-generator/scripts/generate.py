...
# 自动定位 shared-lib（支持项目级和全局安装）
# 结构: skills/illustration-generator/scripts/generate.py
_SKILLS_BASE = Path(__file__).resolve().parent.parent.parent
shared_lib_path = str(_SKILLS_BASE / 'shared-lib')
