...
description: First-time setup flow for social-cover-image preferences
---
...
Platform guidance: WeChat public account article headers use `2.35:1`. X headers use `5:2`, which currently requires generating a wide image and cropping afterward.
